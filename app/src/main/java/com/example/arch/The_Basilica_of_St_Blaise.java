...
public class The_Basilica_of_St_Blaise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.st_blaise);

        FloatingActionButton location = findViewById(R.id.location);

        String locationUrl = "https://maps.app.goo.gl/657jmJShtMzRiomRA";
        ...
        link1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                goLink("https://www.youtube.com/watch?v=UHgg273z10U");
        ...
        link2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                goLink("https://maratea.info/st-blase-the-patron-saint-of-maratea.html");
