...
public class Basilica_of_San_Francesco extends AppCompatActivity {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.san_francesco);

        FloatingActionButton location = findViewById(R.id.location);

        String locationUrl = "https://maps.app.goo.gl/oQiCAyCtDrxssUi47";
        ...
        link1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                goLink("https://www.youtube.com/watch?v=-724jjGsbhM");
        ...
        link2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                goLink("https://www.sanfrancescoassisi.org/html/ita/index.php");
