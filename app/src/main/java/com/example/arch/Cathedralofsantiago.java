...
public class Cathedralofsantiago extends AppCompatActivity {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cathedralofsantiago);

        FloatingActionButton location = findViewById(R.id.location);

        String locationUrl = "https://maps.app.goo.gl/6gmPj3bTBGZQ3XbC9";
