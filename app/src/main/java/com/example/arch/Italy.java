...
public class Italy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView materaphoto = findViewById(R.id.materaphoto);
        ImageView marateaphoto = findViewById(R.id.marateaphoto);
        ImageView assisiphoto = findViewById(R.id.assisiphoto);
        ImageView perugiaphoto = findViewById(R.id.perugiaphoto);


        marateaphoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Italy.this, maratea.class));
            }
        });
